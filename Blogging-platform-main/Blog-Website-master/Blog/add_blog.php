    ...
    {	
      echo "<script>alert('Opps fill the details!');</script>"; 
    ...
    else
          {
            ...
            // $store = "uploads/" . $fnew;
            // Escape and sanitize other form inputs
            $title = mysqli_real_escape_string($db, $_POST['bg_title']);
            $content = mysqli_real_escape_string($db, $_POST['bg_content']);
            $category = mysqli_real_escape_string($db, $_POST['bg_category']);
            $user_name = mysqli_real_escape_string($db, $user_name); // Assuming $user_name is already sanitized
...
echo $image_name;
            ...
            $sql = "INSERT INTO blogs (title, content, author, category, image) VALUES ('$title', '$content', '$user_name', '$category', '$image_name')";
